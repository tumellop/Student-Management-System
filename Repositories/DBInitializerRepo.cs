    ...
    public class DBInitializerRepo : IDBInitializer
    {
        public void Initialize(SQLiteDBContext context)
        {
            ...
            var students = new Student[]
            {
                ...
                EnrollmentDate=DateTime.Parse("2021-02-03"), Photo = "DefaultPic.png", Email="Default@gmail.com"},
                            new Student{StudentNumber="2012000002",
                FirstName="Meredith",Surname="Alonso",EnrollmentDate=DateTime.Parse("2021-02-01"),  Photo = "DefaultPic.png", Email="Default@gmail.com"},
                            new Student{StudentNumber="2021000003",
                FirstName="Arturo",Surname="Anand",EnrollmentDate=DateTime.Parse("2021-02-04"),  Photo = "DefaultPic.png", Email="Default@gmail.com"}
            };
